...
Please review, clean, merge and update code which starts at the comment "<!-- Social Studies Content -->", which covers the Social Studies section in the grade5.html file. Ensure the material is accurate and clear enough for the student at that level to understand. Please note that I want you to organize by big themes rather than strand. Compare that section with the reference content provided below. 

Please review, clean, merge and update code which starts at the comment "<!-- Language Arts Content -->", which covers the Language Arts section in the grade5.html file. Ensure the material is accurate and clear enough for the student at that level to understand. Please note that I want you to organize by big themes rather than strand. Compare that section with the reference content provided below. 

Please review, clean, merge and update code which starts at the comment "<!-- Science Content -->", which covers the Science section in the grade5.html file. Ensure the material is accurate and clear enough for the student at that level to understand. Please note that I want you to organize by big themes rather than strand. Compare that section with the reference content provided below. 

Please review, clean, merge and update code which starts at the comment "<!-- Mathematics Content -->", which covers the Mathematics section in the grade5.html file. Ensure the material is accurate and clear enough for the student at that level to understand. Please note that I want you to organize by big themes rather than strand. Compare that section with the reference content provided below. 